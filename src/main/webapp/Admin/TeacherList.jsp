...
<div class="content-wrapper">
	<div class="container-fluid">
					...
					<div class="col-lg-2">
						<form action="DeleteTeacherServlet" method="post">
							<button style="display: none;" type="submit"
								class="btn btn-light px-5" id="deleteAction">
								<i class="bi bi-person-x"></i> Xóa
							</button>
							<a class="btn btn-light px-5" onclick="funcDel()"> <i
								class="bi bi-person-x"></i> Xóa
							</a> <input style="display: none;" type="text"
								name="txtIDGiaoVienDelete" id="txtIDGiaoVienDelete"
								style="display: block;" />
						</form>
					</div>
					<div class="col-lg-2">
						<button type="submit" class="btn btn-light px-5" onclick="ShowAndHide()">
							<i class="bi bi-person-add"></i> Import
						</button>
					</div>
									...
									<div class="modal-body">
										<div class="form-group">
											<label for="message-text" class="col-form-label"
												...
												type="text" readonly id="idgvUpdate"
												name="txtIDGiaoVienUpdate" style="width: 100%;" value="">
										</div>
										<div class="form-group">
											<label for="message-text" class="col-form-label"
										...
										<div class="form-group">
											<label for="message-text" class="col-form-label"
												...
												id="emailgvUpdate" name="txtEmailGiaoVienUpdate"
												style="width: 100%;" required="required">
										</div>
										<div class="form-group">
											<label for="message-text" class="col-form-label"
												style="color: #000;">Địa chỉ: </label> <input type="text"
												id="diachigvUpdate" name="txtDiaChiGiaoVienUpdate"
												style="width: 100%;">
										</div>
										...
										<div class="form-group"
											...
											<label for="message-text" class="col-form-label"
												style="color: #000;">Tài Khoản: </label> <select
												style="height: 4vh;" id="idtkgvUpdate" class="form-select"
												name="txtMaTaiKhoanUpdate" required="required">
		...
		<div class="card" id="UploadFileSection" style="display: none;width: 0%;transition: all 0.8s;">
			<div class="card-body">
				<div class="col-lg-10">
					<h5>
						Nếu chưa có mẫu vui lòng tải mẫu excel <a
							href="FileDownloadServlet" style="text-decoration: underline;">tại đây</a>
					</h5>
				</div>
				<div class="col-lg-5">
					<form action="UploadListTeacherServlet" method="post"
									...
									<th scope="row">
										<div class="icheck-material-white" style="margin: 0">
											<input class="form-check-input" type="radio"
												name="selectGiaoVien" id="user-checkbox${item.idGiaoVien }"
												value="${item.idGiaoVien}" aria-label="..."
												onclick="GetDataUpdate('${item.idGiaoVien}')"> <label
												for="user-checkbox${item.idGiaoVien }" name="selectedList"></label>
										</div>
									</th>
									<td>${i.index+1}</td>
									<td>${item.idGiaoVien}</td>
									<td>${item.hoTenGiaoVien}<input style="display: none;"
										type="text" id="hotengvdata${item.idGiaoVien }"
										value="${item.hoTenGiaoVien}"> <input
										style="display: none;" type="text"
										id="emailgvdata${item.idGiaoVien }"
										value="${item.emailGiaoVien}"> <input
										style="display: none;" type="text"
										id="diachigvdata${item.idGiaoVien }"
										value=${item.diaChiGiaoVien }> <input
										style="display: none;" type="text"
										id="idtaikhoandata${item.idGiaoVien }"
				...
				<div class="modal-content">
					...
					<form action="AddTeacherServlet" method="post">
						<div class="modal-body">
							<div class="form-group">
								<label for="message-text" class="col-form-label"
									style="color: #000;">ID giáo viên: </label> <input type="text"
									id="recipient-name" name="txtIDGiaoVien"
									value="<%=sDao.Matutang()%>" style="width: 100%;">
							</div>
							<div class="form-group">
								<label for="message-text" class="col-form-label"
									style="color: #000;">Tên giáo viên: </label> <input type="text"
									id="recipient-name" name="txtTenGiaoVien" style="width: 100%;" required="required">
							</div>
							<div class="form-group">
								<label for="message-text" class="col-form-label"
									style="color: #000;">Email: </label> <input type="text"
									id="recipient-name" name="txtEmail" style="width: 100%;" required="required">
							</div>
							<div class="form-group">
								<label for="message-text" class="col-form-label"
									style="color: #000;">Địa chỉ: </label> <input type="text"
							...
							<div class="form-group"
								...
								<label for="message-text" class="col-form-label"
									style="color: #000;">Tài Khoản: </label> <select
									style="height: 4vh;" id="idtksv" class="form-select"
									name="txtMaTaiKhoan" required="required">
									<option style="background: #fff !important;" selected>Chọn
										tài khoản</option>
									<c:forEach var="tk" items="${tklist}">
										<option style="background: #fff !important;"
					...
					<form action="DetailTeacherServlet" method="post">
						<c:forEach var="item" items="${list}">
							...
							<div class="modal-body">
								<div class="form-group">
									<label for="message-text" class="col-form-label"
										style="color: #000;">ID giáo viên: ${item.idGiaoVien}
									</label>
								</div>
								<div class="form-group">
									<label for="message-text" class="col-form-label"
										style="color: #000;">Tên giáo viên:
										${item.hoTenGiaoVien}</label>
								</div>
								<div class="form-group">
									<label for="message-text" class="col-form-label"
	...
	function ShowAndHide() {
		var x = document.getElementById("UploadFileSection");
