...
<body class="bg-purple">
        ...
        <div class="stars">
            ...
            <div class="central-body">
                ...
                <h1 style="color: white; font-size: 180px;margin-top: -130px;">403</h1>
                <h3 style="color: white; font-size: 50px; margin-top: -100px;"> Bạn không có quyền truy cập chức năng này!</h3>
