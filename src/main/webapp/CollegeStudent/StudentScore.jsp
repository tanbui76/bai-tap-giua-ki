...
<div class="content-wrapper">
    ...
    <h3 class="result" style="text-align: center; color: white">Kết quả học tập sinh viên</h3>  
    <table  width="100%" class="soft">
      <tbody>
        <tr>
          <td align="right" width="40%" style="font-size: 20px;">Năm học - Học kỳ: </td>
          <td align="left">
            <select >
        ...
        <tr>
          <td align="center" colspan="2">
            <input type="button" name="btnSave" id="btnSave" value="Xem" onclick="xem()">
          </td>
        </tr>
      </tbody>
    </table>
    <fieldset class="list">
      ...
      <div class="divp-list" style="overflow:auto" id="divp_xemketquahoctap_0">
        <table id="tb_xemketquahoctap_0" style="border-collapse: collapse;" name="tb_xemketquahoctap_0" width="100%"
          border="1" class="table-list fixheader">
          <thead>
            <tr class="table">
              <th rowspan="2" align="center" style="width: 55px;">Stt</th>
              <th rowspan="2" align="center" style="width: 166px;">Mã môn học</th>
              <th rowspan="2" align="center" style="width: 250px;">Tên môn học</th>
              <th rowspan="2" align="center" style="width: 80px;">Nhóm</th>
              <th colspan="2" align="center" style="width: 166px;">Điểm HP hệ 10</th>
              <th colspan="2" align="center" style="width: 166px;">Điểm HP hệ 4</th>
              <th rowspan="2" align="center" style="width: 62px;">Chi tiết</th>
            </tr>
          </thead>
          <tbody>
            <tr class="alt">
              ...
              <td align="left" class="">Xác suất thống kê</td>
              ...
              <td align="center" width="7%" class=""></td>
              <td align="center" width="7%" class=""> <a href="./">Chitiet1</a></td>
            </tr>
            <tr>
      ...
      <table  width="100%" border="0" class="fixheader">
        <tbody>
          <tr>
            <td align="left" width="30%" class="normal">Điểm trung bình học kỳ hệ 10</td>
            <td align="left" width="20%" class="normal"><b>8.54</b></td>
            <td align="left" width="30%" class="normal"> Điểm trung bình học kỳ hệ 4</td>
